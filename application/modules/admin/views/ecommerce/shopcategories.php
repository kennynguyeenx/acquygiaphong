<div id="languages">
    <h1><img src="<?= base_url('assets/imgs/categories.jpg') ?>" class="header-img" style="margin-top:-2px;"> Hãng xe</h1> 
    <hr>
    ...
    ?>
    <a href="javascript:void(0);" data-toggle="modal" data-target="#add_edit_articles" class="btn btn-primary btn-xs pull-right" style="margin-bottom:10px;"><b>+</b> Thêm mới</a>
                ...
                foreach ($shop_categories as $key_cat => $shop_categorie) {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if($shop_categorie['position']==0) { ?>
                                <span id="position-<?= $key_cat ?>"><?= $shop_categorie['position'] ?></span>
                            <?php } else {?>
                                <span id="position-<?= $key_cat ?>"><b><?= $shop_categorie['position'] ?></b></span>
                            <?php } ?>   
                        </td>
            ...
            <div class="modal-content">
                <form action="" method="POST">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Thêm hãng xe</h4>
                    </div>
