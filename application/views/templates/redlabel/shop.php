                                ...
                                <div class="table_layout filter-shopby">
                                    <div class="table_row">
                                        ...
                                        <div class="table_cell">
                                            <fieldset>
                                                <legend>Hãng xe</legend>
                                                <ul class="checkboxes_list">
                                                    <?php foreach ($home_categories as $category) { ?>
                                                        <li>
                                                            <input type="checkbox" checked="">
                                                            <label for="category_1"><?= $category['name'] ?></label>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </fieldset>
                                        ...
                                        <div class="table_cell">
                                            <fieldset>
                                                <legend>Hãng ắc quy</legend>
                                                <ul class="checkboxes_list">
                                                    <?php foreach ($brands as $brand) { ?>
                                                        <li>
                                                            <input type="checkbox" checked="">
                                                            <label for="manufacturer_1"><?= $brand['name'] ?></label>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </fieldset>
                                        ...
                                        <!-- <div class="table_cell">
                                            <fieldset>
                                                <legend>Điện áp</legend>
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <ul class="simple_vertical_list">
                                                            <li>
                                                                <input type="checkbox" checked="">
                                                                <label for="color_btn_1" >12 Ah</label>
                                                            </li>
                                                            <li>
                                                                <input type="checkbox" name="" id="color_btn_2">
                                                                <label for="color_btn_2" >20 Ah</label>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <ul class="simple_vertical_list">
                                                            <li>
                                                                <input type="checkbox" checked="">
                                                                <label for="color_btn_1" >28 Ah</label>
                                                            </li>
                                                            <li>
                                                                <input type="checkbox" name="" id="color_btn_4">
                                                                <label for="color_btn_4" >30 Ah</label>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
